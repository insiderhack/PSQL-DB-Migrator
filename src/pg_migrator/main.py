...
from .ui.theme import get_theme, BANNER_COMPACT
from .ui.components import create_console, create_header, create_panel
from .ui.screens import MigrationWizard
from .config import get_config, AppConfig
from .detector import VersionDetector, detect_version_from_dsn
...
def check(host: str, port: int, database: str, user: str, password: str, target: bool):
    """
